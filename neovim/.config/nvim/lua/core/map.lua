...
map('n', '<C-x>k', cmd('bdelete'), { noremap = true, silent = true })
...
map('n', '<C-t>j', cmd('tabp'), { noremap = true, silent = true })
map('n', '<C-t>k', cmd('tabn'), { noremap = true, silent = true })
map('n', '<C-t>n', cmd('tab split'), { noremap = true, silent = true })
map('n', '<C-t>c', cmd('tabclose'), { noremap = true, silent = true })
...
map('i', '<C-u>', '<C-O>u', { noremap = true })
map('i', '<C-j>', '<Esc>o', { noremap = true })
map('i', '<C-k>', '<Esc>O', { noremap = true })
map('i', '<C-s>', '<Esc>:w', { noremap = true })
map('i', '<C-q>', '<Esc>:wq', { noremap = true })
