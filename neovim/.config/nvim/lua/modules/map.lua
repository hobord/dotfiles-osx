...
-- EasyAlign
map("n", "s", function() require('leap').leap { target_windows = { vim.fn.win_getid() } } end,
  { noremap = true, silent = true, desc = "Leap" })
map("x", "ga", '<Plug>(EasyAlign)', { noremap = true, silent = true, desc = "EasyAlign" })

-- Packer
map("n", "<leader><leader>Pu", cmd("PackerUpdate"),
  { noremap = true, silent = true, nowait = true, desc = "Packer Update" })
map("n", "<leader><leader>Pi", cmd("PackerInstall"),
  { noremap = true, silent = true, nowait = true, desc = "Packer Install" })
map("n", "<leader><leader>Pc", cmd("PackerCompile"),
...
map("n", "<Leader>Gh", cmd("DiffviewFileHistory %"),
  { noremap = true, silent = true, desc = "Diffview Current File History" })
...
map("n", "H", function() vim.lsp.buf.hover({ border = 'single', max_width = 80, max_heigt = 40 }) end,
...
map("n", "<Leader>gr", cmd('Glance references'), { noremap = true, silent = true, desc = "References" })
map("n", "<Leader>gd", cmd('Glance definitions'), { noremap = true, silent = true, desc = "Definitions" })
...
map("n", "<M-p>", cmd("Telescope neoclip unnamed"),
  { noremap = true, silent = true, nowait = true, desc = "Telescope neoclip unnamed" })
...
map("n", "<Leader>d",
  ...
  { noremap = true, silent = true, desc = "File browser current dir" })
map("n", "<Leader>fr", cmd('Telescope oldfiles'), { noremap = true, silent = true, desc = "Recent files" })
map("n", "<Leader>ff", cmd('Telescope find_files find_command=rg,--hidden,--files'),
...
map("n", "<Leader>fz", cmd('Telescope current_buffer_fuzzy_find'),
...
-- DAP
map("n", "<Leader>rb", function() require 'dap'.toggle_breakpoint() end,
  { noremap = true, silent = true, nowait = true, desc = "Toggle breakpoint" })
map("n", "<Leader>rB", function() require 'dap'.set_breakpoint(vim.fn.input('Breakpoint condition:')) end,
  { noremap = true, silent = true, nowait = true, desc = "Set breakpoint condition" })
map("n", "<Leader>rd", function() require 'dapui'.toggle() end,
  { noremap = true, silent = true, nowait = true, desc = "Toggle DAP UI" })
map("n", "<Leader>rc", function() require 'telescope'.extensions.dap.configurations {} end,
  { noremap = true, silent = true, nowait = true, desc = "DAP configurations" })
map("n", "<Leader>rr", function() require 'dap'.continue() end,
  { noremap = true, silent = true, nowait = true, desc = "DAP continue <F5>" })
map("n", "<F5>", function() require 'dap'.continue() end,
  { noremap = true, silent = true, nowait = true, desc = "DAP continue" })
map("n", "<F10>", function() require 'dap'.step_over() end,
  { noremap = true, silent = true, nowait = true, desc = "DAP step over" })
map("n", "<Leader>rn", function() require 'dap'.step_over() end,
  { noremap = true, silent = true, nowait = true, desc = "DAP step over <F10>" })
map("n", "<F11>", function() require 'dap'.step_into() end,
  { noremap = true, silent = true, nowait = true, desc = "DAP step into" })
map("n", "<Leader>ri", function() require 'dap'.step_into() end,
  { noremap = true, silent = true, nowait = true, desc = "DAP step into <F11>" })
map("n", "<F9>", function() require 'dap'.step_out() end,
  { noremap = true, silent = true, nowait = true, desc = "DAP step out" })
map("n", "<Leader>ro", function() require 'dap'.step_out() end,
  { noremap = true, silent = true, nowait = true, desc = "DAP step out <F9>" })
-- map("n", "<Leader>re",  function() require'dap'.disconnect() end, { noremap = true, silent = true, nowait = true, desc="DAP disconnect" })
map("n", "<Leader>rt", function() require('gotest').run_test() end,
  { noremap = true, silent = true, nowait = true, desc = "Run test" })
map("n", "<Leader>r[", function() require('gotest').clean_last_run() end,
  { noremap = true, silent = true, nowait = true, desc = "CleanLastRun" })
map("n", "<Leader>re", function() require('gotest').show_last_test_result() end,
  { noremap = true, silent = true, nowait = true, desc = "Show test result" })
map("n", "<Leader>rT", function() require('dap-go').debug_test() end,
  { noremap = true, silent = true, nowait = true, desc = "DAP Debug test" })
map("n", "<Leader>rh", function() require 'dap.ui.widgets'.hover() end,
  { noremap = true, silent = true, nowait = true, desc = "DAP Hoover" })
map("n", "<Leader>rv", function() require 'nvim-dap-virtual-text'.toggle() end,
...
map("i", "<C-l>", function() require('copilot.suggestion').accept() end,
