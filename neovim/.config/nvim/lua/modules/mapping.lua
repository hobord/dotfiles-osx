...
local plug_map = {
    ...
    ["n|<Leader><Leader>t"] = map_cu('lua require"modules.tools.gotest.fn".RunTest()'):with_silent():with_noremap():with_nowait(),
    ["n|<Leader><Leader>tr"] = map_cu('lua require"modules.tools.gotest.fn".ShowLastTestReults()'):with_silent():with_noremap():with_nowait(),
    ["n|<Leader><Leader>tt"] = map_cu('lua require"modules.tools.gotest.fn".RunLastTest()'):with_silent():with_noremap():with_nowait(),
