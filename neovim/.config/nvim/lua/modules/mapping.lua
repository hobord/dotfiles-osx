...
local plug_map = {
  ...
  ["n|<Leader><Leader>t"]  = map_cu('lua require"modules.tools.gotest".RunTest()'):with_silent():with_noremap():
      with_nowait(),
  ["n|<Leader><Leader>tr"] = map_cu('lua require"modules.tools.gotest".ShowLastTestReults()'):with_silent():with_noremap()
      :with_nowait(),
  ["n|<Leader><Leader>tt"] = map_cu('lua require"modules.tools.gotest".RunLastTest()'):with_silent():with_noremap():
      with_nowait(),
  ...
  ["n|<Leader><Leader>H"]  = map_cu('DiffviewFileHistory'):with_silent():with_noremap(),
  ["n|gs"]                 = map_cu('Gitsigns toggle_signs'):with_silent():with_noremap(),
  ...
  ["n|<Leader>fh"]         = map_cu("lua require('telescope').extensions.frecency.frecency()"):with_noremap():
      with_silent(),
  ["n|<Leader>fb"]         = map_cu("lua require('telescope').extensions.file_browser.file_browser()"):with_noremap():
      with_silent(),
  ["n|<Leader>d"]          = map_cu("lua require('telescope').extensions.file_browser.file_browser({ cwd = vim.fn.expand('%:p:h'), })")
  ...
  ["n|<Leader>fz"]         = map_cu('Telescope current_buffer_fuzzy_find'):with_noremap():with_silent(),
  ...
  ["n|<Leader><Leader>B"]  = map_cu("lua require'dap'.set_breakpoint(vim.fn.input('Breakpoint condition:'))"):
      with_noremap():with_nowait():with_silent(),
  ["n|<Leader><Leader>d"]  = map_cu("lua require'dapui'.toggle()"):with_noremap():with_nowait():with_silent(),
  ["n|<Leader><Leader>s"]  = map_cu("lua require'telescope'.extensions.dap.configurations{}"):with_noremap():with_nowait()
      :with_silent(),
  ...
  ["i|<C-l>"]              = map_cu('lua require("copilot.suggestion").accept()'):with_noremap():with_silent():with_expr(),
