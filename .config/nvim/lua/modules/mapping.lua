...
local plug_map = {
    ...
    ["n|<F1>"]         = map_cu("lua require'dap'.step_over()"):with_noremap():with_nowait():with_silent(),
    ["n|<F2>"]         = map_cu("lua require'dap'.step_into()"):with_noremap():with_nowait():with_silent(),
    ["n|<F3>"]         = map_cu("lua require'dap'.step_out()"):with_noremap():with_nowait():with_silent(),
    ["n|<F10>"]        = map_cu("lua require'dap'.disconnect()"):with_noremap():with_nowait():with_silent(),
