...
local plug_map = {
    ...
    ["n|<leader><Down>"]         = map_cr('Lspsaga preview_definition'):with_noremap():with_silent(),
    ...
    ["n|<leader><Up>"]      = map_cu('lua vim.lsp.diagnostic.show_line_diagnostics({border="single"})'):with_noremap():with_silent(),
    ...
    ["n|<Leader><Leader>t"] = map_cu("lua require('dap-go').debug_test()"):with_noremap():with_nowait():with_silent(),
