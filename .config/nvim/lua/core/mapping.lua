...
local def_map = {
  ...
  ["n|<C-PageUp>"]        = map_cr('bp'):with_noremap(),
  ["n|<C-PageDown>"]      = map_cr('bn'):with_noremap(),
  ["n|]b"]                = map_cr('bp'):with_noremap(),
  ["n|[b"]                = map_cr('bn'):with_noremap(),
  ["n|<C-S-PageUp>"]      = map_cr('BufferLineMovePrev'),
  ["n|<C-S-PageDown>"]    = map_cr('BufferLineMoveNext'),
  ["n|<C-t><UP>"]         = map_cr('tabr'),
  ["n|<C-t><DOWN>"]       = map_cr('tabl'),
  ["n|<C-t><LEFT>"]       = map_cr('tabp'),
  ["n|<C-t><RIGHT>"]      = map_cr('tabn'),
  ["n|<C-t>n"]            = map_cr('tabnew'),
  ["n|<Leader>tc"]        = map_cr('tabclose'),
